                ...
                >
                  ...
                  <div className="flex justify-end gap-2 mt-auto pt-4">
                    <button
                      ...
                      className="w-full md:w-32 py-2 font-semibold rounded-lg text-indigo-900 bg-blue-100 
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-end sm:gap-3 gap-2">
                        ...
                        <div className="flex sm:mt-6">
                          <button
                            ...
                            className="bg-blue-500 text-white px-4 py-1 rounded-lg hover:bg-blue-700 transition whitespace-nowrap cursor-pointer"
                          >
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-2 mt-auto pt-4">
                      <div className="flex">
                        <button
                          ...
                          className="w-full md:w-32 py-2  font-semibold rounded-lg text-indigo-900 bg-blue-100 
                      border border-transparent 
                      hover:bg-blue-200 hover:border-blue-300 text-center cursor-pointer"
                        >
                      ...
                      <div className="w-full">
                        <div className="grid grid-cols-1 md:grid-cols-[3fr_1.5fr_auto] gap-4 items-end">
                          ...
                          <div className="flex flex-col w-full">
                            <label className="text-sm font-medium mb-1 flex items-center gap-1">
                              {t(
                                "tela_perfil_avaliador.item_label_certificacao",
                              )}
                              <TooltipIcon
                                message={`${t(
                          ...
                          <div className="flex flex-col w-full">
                            <label className="text-xs sm:text-sm font-medium mb-1">
                              {t(
                                "tela_perfil_avaliador.item_label_certificado",
                              )}
                            </label>
                            <input
                              type="file"
                ...
                <div className="w-full flex flex-col flex-1">
                  ...
                  >
                    <div>
                      <h1 className="block text-sm mb-1 py-3 font-bold">
                        {t(
                          "tela_perfil_avaliador.item_label_informe_hardskills",
                        )}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="bg-blue-500 text-white px-4 py-1 rounded-lj hover:bg-blue-700 transition whitespace-nowrap cursor-pointer"
                        >
                          {t("tela_perfil_avaliador.item_botao_adicionar")}
                        </button>
                      </div>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between flex-wrap gap-4 sm:gap-8">
                                  ...
                                  <div className="flex items-center gap-2 text-sm min-w-[200px]">
                                    <label className="font-medium whitespace-nowrap">
                                      {t(
                                        "tela_perfil_avaliador.item_label_peso",
                                      )}
                                    </label>
                                    <input
                                      type="range"
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-2 mt-auto pt-4">
                      ...
                      hover:bg-blue-200 hover:border-blue-300 cursor-pointer"
                        ...
                        <button
                          ...
                          className={`w-full md:w-32 py-2 font-semibold rounded-lg text-indigo-900
                      border border-transparent 
                      
                      ${
                        form.lista_skills.length < 3
                          ? "bg-gray-300 cursor-not-allowed"
                          : "bg-blue-100 hover:bg-blue-200 hover:border-blue-300 cursor-pointer"
                      }`}
                        >
                          {t("tela_perfil_avaliador.item_botao_avancar")}
                        </button>
                ...
                <div className="w-full flex flex-col flex-1">
                  ...
                  >
                    <div>
                      <h1 className="block text-sm mb-1 py-3 font-bold">
                        {t(
                          "tela_perfil_avaliador.item_label_informe_softskills",
                        )}
                        <p className="text-[11px] font-normal italic">
                          {t(
                  ...
                  >
                              ...
                              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden flex-shrink-0">
                                {form.logoPreview ? (
                                  ...
                                  <div className="text-xs text-gray-400 flex items-center justify-center h-full">
                                    {t(
                                      "tela_perfil_avaliador.item_msg_sem_foto",
                                    )}
                                  </div>
                                )}
                              </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-2 mt-auto pt-4">
                      ...
                      hover:bg-blue-200 hover:border-blue-300 cursor-pointer"
                        ...
                        <button
                          type="submit"
                          className={`px-6 py-2 font-semibold flex items-center justify-center gap-2 ${
                            isFormValid(form)
                              ? "rounded-lg text-indigo-900 bg-blue-100 border border-transparent hover:bg-blue-200 hover:border-blue-300 cursor-pointer"
                              : "bg-gray-300 cursor-not-allowed"
                          }`}
                        >
                          {isSubmitting ? (
