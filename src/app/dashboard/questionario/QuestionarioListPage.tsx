            ...
            <PageContainer>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full">
                  ...
                  <input
                    type="text"
                    placeholder={t("questionario.filtro_busca")}
                    value={busca}
                    onChange={(e) => {
                  ...
                  >
                    <option value="todos">
                      {t("questionario.filtro_ativo_todos")}
                    </option>
                    <option value="ativo">
                      {t("questionario.filtro_ativo")}
                    </option>
                    <option value="inativo">
                      {t("questionario.filtro_inativo")}
                    </option>
                  </select>
                </div>
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold rounded-lg text-indigo-900 bg-blue-100 
              ...
              <div className="text-xs text-gray-400 mb-3">
                ...
                {t("questionario.resultado_busca")}
              </div>
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-4 pt-3 border-t">
                      <Link
                        ...
                        className="flex-1 flex items-center justify-center gap-1 py-2 text-xs font-semibold  rounded-lg text-indigo-900 bg-blue-100 
                      border border-transparent 
                      ...
                      <button
                        ...
                        disabled={excluindo}
                        className="flex-1 flex items-center justify-center gap-1 py-2 text-xs font-semibold rounded-lg text-red-600 bg-blue-100 
                      border border-transparent 
                      hover:bg-blue-200 hover:border-blue-300  cursor-pointer"
                      >
                        <Trash2 size={14} />
